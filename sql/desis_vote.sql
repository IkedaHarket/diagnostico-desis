...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-06-2023 a las 21:31:27
...
INSERT INTO `candidate` (`id`, `candidate`) VALUES
(1, 'Sra. María Candelaria Acevedo'),
(2, 'Sr. Eric Aedo'),
(3, 'Sra. Yovana Ahumada'),
(4, 'Sr. Jorge Alessandri'),
(5, 'Sr. René Alinco'),
(6, 'Sr. Jaime Araya'),
(7, 'Sr. Cristián Araya'),
(8, 'Sra. Mónica Arce'),
(9, 'Sr. Roberto Arroyo'),
(10, 'Sra. Danisa Astudillo'),
(11, 'Sra. Chiara Barchiesi'),
(12, 'Sr. Boris Barrera'),
(13, 'Sr. Héctor Barría'),
(14, 'Sr. Miguel Ángel Becker'),
(15, 'Sra. María Francisca Bello'),
(16, 'Sr. Juan Carlos Beltrán'),
(17, 'Sr. Gustavo Benavente'),
(18, 'Sr. Bernardo Berger'),
(19, 'Sr. Alejandro Bernales'),
(20, 'Sr. Carlos Bianchi'),
(21, 'Sr. Sergio Bobadilla'),
(22, 'Sr. Fernando Bórquez'),
(23, 'Sra. Ana María Bravo'),
(24, 'Sra. Marta Bravo'),
(25, 'Sr. Jorge Brito'),
(26, 'Sr. Félix Bugueño'),
(27, 'Sra. Mercedes Bulnes'),
(28, 'Sr. Miguel Ángel Calisto'),
(29, 'Sr. Felipe Camaño'),
(30, 'Sra. Karol Cariola');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `knowus`
--
...
--
-- Volcado de datos para la tabla `knowus`
--

INSERT INTO `knowus` (`id`, `label`) VALUES
(1, 'Web'),
(2, 'TV'),
(3, 'Redes Sociales'),
(4, 'Amigo');
...
--
-- Estructura de tabla para la tabla `votes_knowus`
--

CREATE TABLE `votes_knowus` (
  `id` int(11) NOT NULL,
  `id_votes` int(11) NOT NULL,
  `id_knowus` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indices de la tabla `votes_knowus`
--
ALTER TABLE `votes_knowus`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_votes` (`id_votes`),
  ADD KEY `id_knowus` (`id_knowus`);
...
--
-- AUTO_INCREMENT de la tabla `knowus`
--
ALTER TABLE `knowus`
...
--
-- AUTO_INCREMENT de la tabla `votes_knowus`
--
ALTER TABLE `votes_knowus`
...
--
ALTER TABLE `votes`
  ADD CONSTRAINT `votes_ibfk_1` FOREIGN KEY (`id_candidate`) REFERENCES `candidate` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `votes_ibfk_4` FOREIGN KEY (`id_region`) REFERENCES `tbl_region` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `votes_ibfk_5` FOREIGN KEY (`id_commune`) REFERENCES `tbl_comuna` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `votes_knowus`
--
ALTER TABLE `votes_knowus`
  ADD CONSTRAINT `votes_knowus_ibfk_2` FOREIGN KEY (`id_votes`) REFERENCES `votes` (`id`);
COMMIT;
